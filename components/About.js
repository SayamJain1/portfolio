    ...
    <section className="px-6 py-20 sm:px-20 sm:py-32">
      ...
      <div className="w-full ">
        <div className="flex items-center gap-4">
          ...
          <button
            type="button"
            className="px-5 py-2 text-sm font-semibold text-black bg-gray-200 border rounded-full focus:outline-none hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
          >
            Resume
          </button>
        </div>
